          ...
          <div class="col-lg-4 order-lg-2">
            <div class="service-sidebar">
              <div class="service-hero" data-aos="zoom-in" data-aos-delay="150">
                <img src="{{ asset('forntend/assets/img/real-estate/property-interior-5.webp') }}" alt="Property Investment Service" class="img-fluid">
              ...
              <div class="quick-contact-card" data-aos="slide-up" data-aos-delay="200">
                ...
                <form action="{{ route('services_contact') }}" method="post">
                    @csrf
                ...
                <div class="testimonial-grid">
                  <div class="testimonial-card">
                    ...
                    <div class="client-info">
                      <img src="{{ asset('forntend/assets/img/person/person-m-7.webp') }}" alt="Michael Chen" class="client-photo">
                  ...
                  <div class="testimonial-card">
                    ...
                    <div class="client-info">
                      <img src="{{ asset('forntend/assets/img/person/person-f-12.webp') }}" alt="Jennifer Rodriguez" class="client-photo">
                      <div class="client-details">
