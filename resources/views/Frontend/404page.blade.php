      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1 class="heading-title">404 Page</h1>
              <p class="mb-0">
              </p>
            </div>
          </div>
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
              <div class="error-content">
                ...
                <div class="error-suggestions" data-aos="fade-up" data-aos-delay="900">
                  ...
                  <ul>
                    <li><a href="{{ route('properties') }}"><i class="bi bi-arrow-right-circle"></i> Check our properties</a></li>
                    <li><a href="{{ route('contact') }}"><i class="bi bi-arrow-right-circle"></i> Contact support</a></li>
                    <li><a href="{{ route('home') }}"><i class="bi bi-arrow-right-circle"></i> Return to Home page</a></li>
                  </ul>
                </div>
              </div>
            </div>
