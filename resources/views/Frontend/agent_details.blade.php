      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="agent-profile-card" data-aos="zoom-in" data-aos-delay="150">
          <div class="profile-background">
            <img src="{{ asset('forntend/assets/img/real-estate/property-exterior-4.webp') }}" alt="Background" class="profile-bg-image">
          </div>

          <div class="profile-content">
            <div class="agent-avatar">
              <img src="{{ asset('uploads/agent/'.$agent->photo) }}" alt="Agent" class="avatar-image">
            ...
            <div class="agent-header">
              ...
              <div class="agent-credentials">
                <span class="title">{{ $agent->designation }}</span>
              ...
              <div class="quick-stats">
                ...
                <div class="quick-stat">
                  <span class="stat-value">{{ number_format($active_property,0,",") }}</span>
                  <span class="stat-label">Properties Active</span>
                </div>
                <div class="quick-stat">
        ...
        <div class="main-content-grid" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="content-sidebar">
            ...
            <div class="contact-widget">
              ...
              <div class="social-connect">
                ...
                <div class="social-links">
                  <a href="{{ $agent->linkedin }}"><i class="bi bi-linkedin"></i></a>
            ...
            <div class="quick-contact-form">
              <h4>Quick Inquiry</h4>
              <form action="{{ route('agent_send_mail',$agent->id) }}" method="post">
                @csrf
                <div class="mb-3">
