    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="card shadow-sm">
                ...
                <a href="{{ route('admin_amenity_create') }}" class="btn btn-primary btn-sm ms-auto">+ Add New Amenity</a>
              </div>
            </div>
        </div>
    </div>
                        ...
                        @if (!empty($amenities))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin_amenity_destroy',$amenity->id)}}" onclick="return confirm('Are you sure you want to delete this amenity?');"><button class="btn btn-action-delete"><i class="bi bi-trash-fill"></i></button></a>
                                    </td>
                                </tr>
                                @endforeach
                            @endif
