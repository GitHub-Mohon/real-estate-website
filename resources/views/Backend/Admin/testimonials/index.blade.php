    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="card shadow-sm">
                ...
                <a href="{{ route('admin_testimonial_create') }}" class="btn btn-primary btn-sm ms-auto">+ Add New Testimonial</a>
              </div>
                        ...
                        @else
                            @foreach ($testimonials as $testimonial)
                                <tr>
                                    ...
                                    <td><img src="{{asset('uploads/testimonials/'. $testimonial->photo . ' ')}}" alt="No Picture" style="width: 100px; height: 80px;"></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin_testimonial_destroy',$testimonial->id)}}" onclick="return confirm('Are you sure you want to delete this testimonial?');"><button class="btn btn-action-delete "><i class="bi bi-trash-fill"></i></button></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
