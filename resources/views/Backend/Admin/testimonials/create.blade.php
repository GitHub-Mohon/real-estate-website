                ...
                <form action="{{route('admin_testimonial_store')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="subject" value="{{ old('subject') }}" name="subject" placeholder="testimonial subject">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="mb-3">
                        <label for="comment" class="form-label">Comments*</label>
                        <textarea name="comments" id="comment" class="form-control" rows="7" placeholder="Type your comments">{{ old('comments') }}</textarea>
                    </div>
                  </div>
