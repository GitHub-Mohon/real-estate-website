    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="card shadow-sm">
                ...
                <a href="{{ route('admin_customer_create') }}" class="btn btn-primary btn-sm ms-auto">+ Add New Customer</a>
              </div>
            </div>
        </div>
    </div>
                    ...
                    <tbody>
                        @if (!empty($customers))
                                ...
                                <tr>
                                    ...
                                    <td>@if ($customer->photo)
                                        <img src="{{asset('uploads/user/'. $customer->photo . ' ')}}" alt="No Picture" style="width: 100px; height: 80px;"></td>
                                    @else
                                    ...
                                    <td>
                                        <a href="{{route('admin_customer_edit',$customer->id)}}">
                                            <button class="btn btn-action-edit me-1"><i class="bi bi-pencil-square"></i></button>
                                        </a>
                                        <a href="{{route('admin_customer_destroy',$customer->id)}}" onclick="return confirm('Are you sure you want to delete this customer?');"><button class="btn btn-action-delete "><i class="bi bi-trash-fill"></i></button></a>
                                    </td>
                                </tr>
                                @endforeach
                            @endif
